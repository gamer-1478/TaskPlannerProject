...
public class Register extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switchPage = (TextView) findViewById(R.id.register_switchPageToLogin);
        registerSubmission = (Button) findViewById(R.id.register_submission);
        ...
        registerSubmission.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
