package com.example.taskplannerproject.adapter;
...
import com.example.taskplannerproject.bottomSheetFragment.CreateTaskBottomSheetFragment;
...
public class TaskAdapter extends RecyclerView.Adapter<TaskAdapter.TaskViewHolder> {
    ...
    public TaskAdapter(HomeScreen context, List<Task> taskList, HomeScreen setRefreshListener) {
